	...
	return (
		...
		>
			...
			<div
				...
				className="no-scrollbar lg:shadowtest relative z-10 shrink-0 rounded-md border-primary lg:min-h-0 lg:overflow-y-auto lg:rounded-xl lg:border-[0px] lg:bg-dark"
			>
				<SparkleEffect
					count={15}
					colors={[
