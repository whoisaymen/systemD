...
// 			<div className="relative z-50 flex flex-wrap items-center justify-center gap-2 rounded-none px-4 py-4">
// 				<div
...
const FabriqueContent: React.FC<FabriqueContentProps> = ({
	...
	return (
		...
		>
			...
			{/* Description */}
			<div className="relative mx-4 mb-12 mt-4 rounded-md bg-primary p-6 sm:py-10 lg:mx-0">
				<p className="mx-auto py-0 text-center text-xl font-bold leading-[1.2] tracking-tighter text-dark dark:text-dark sm:py-4 sm:text-4xl">
			...
			{memoizedValues.actions && (
				<Accordion
					type="single"
					collapsible
					className="mb-0 lg:rounded-md lg:bg-dark lg:bg-gradient-to-t lg:from-grayDark lg:py-32"
				>
					{memoizedValues.actions.map((action: any, index: number) => {
						...
						return (
							<AccordionItem
								...
								className="flex flex-col items-center justify-center"
							>
								<AccordionTrigger className={`${triggerRotation} sm:text-7xl`}>
									<div className="flex flex-col items-center">
										<div className="z-10 inline-block w-fit text-3xl tracking-tighter lg:text-7xl">
											<span className="text-center">
