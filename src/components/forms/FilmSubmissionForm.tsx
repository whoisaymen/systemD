...
// 						className="rounded-xl border-2 border-primary bg-white p-8 dark:bg-dark"
// 					>
// 						<div className="mb-6">
...
// 								<div>
// 									<label className="mb-2 block text-sm font-medium text-dark dark:text-primary">
// 										Nom et prénom de la personne de contact *
// 									</label>
// 									<input
// 										{...register('contactName')}
// 										className="w-full rounded-lg border-2 border-dark px-4 py-3 focus:border-primary focus:outline-none"
...
// 													className="h-4 w-4"
// 												/>
// 												<span className="text-sm text-dark dark:text-primary">
// 													{lang}
// 												</span>
// 											</label>
// 										))}
...
// 										))}
// 									</div>
// 									<p className="text-dark/70 dark:text-primary/70 mt-1 text-xs">
...
// 							<div className="space-y-6">
// 								<div>
// 									<label className="mb-4 block text-sm font-medium text-dark dark:text-primary">
...
// 									<p className="text-sm text-dark dark:text-primary">
...
// 							type="button"
// 							onClick={nextStep}
// 							className="hover:bg-primary/90 flex items-center space-x-2 rounded-lg bg-primary px-6 py-3 text-dark transition-colors"
// 						>
// 							<span>Suivant</span>
// 							<IoArrowForward />
// 						</button>
...
// 							className="hover:bg-primary/90 flex items-center space-x-2 rounded-lg bg-primary px-6 py-3 text-dark transition-colors disabled:cursor-not-allowed disabled:opacity-50"
// 						>
// 							<IoRocket />
...
const filmSubmissionSchema = z.object({
	...
	professionalSupervision: z.string().transform((val) => val === 'true'),
	filmSchoolGraduates: z.string().transform((val) => val === 'true'),
	previousAwards: z.string().optional(),
