			...
			<AccordionPrimitive.Header className="flex">
				<AccordionPrimitive.Trigger
					...
					className={cn(
						...
						'data-[state=open]:border-grayDark data-[state=open]:bg-dark data-[state=open]:text-dark data-[state=open]:dark:border-grayDark data-[state=open]:dark:bg-grayDark data-[state=open]:dark:text-dark lg:hover:bg-grayDark lg:hover:text-dark',
						className,
					)}
					{...props}
				>
